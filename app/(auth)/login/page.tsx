...
// We need Suspense because useSearchParams() needs it in Next.js
function LoginForm() {
  const router = useRouter();
  const searchParams = useSearchParams();

  // If middleware redirected them here from /dashboard,
  // callbackUrl will be "/dashboard"
  ...
  async function handleCredentialsLogin(e: React.FormEvent) {
    ...
    // Send them to where they originally wanted to go
